...
RUN if [ "$deep4downscaling" = true ]; then \
    ...
    . /root/.bashrc; \
	mamba create -n deep4downscaling_py311_cu12 -c conda-forge python==3.11.* jupyter xarray cartopy numpy scipy pandas xskillscore bottleneck pytorch::pytorch==2.5.1 -y; \
