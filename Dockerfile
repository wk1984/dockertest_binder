...
# 2. 下载 CRYOWRF v1.0
RUN git clone https://gh-proxy.com/https://github.com/wk1984/CRYOWRF.git .
...
ENV NETCDF=/opt/cryowrf/libraries/local_libs
ENV PATH=/opt/cryowrf/libraries/local_libs/bin:$PATH
ENV LD_LIBRARY_PATH=/opt/cryowrf/libraries/local_libs/lib:$LD_LIBRARY_PATH
