...
RUN . /root/.bashrc \ 
    && mamba create -n dl4ds_py39_cu11 -c conda-forge python==3.9.* gcc libstdcxx xarray cartopy requests hdf5 h5py netCDF4 scikit-learn cudatoolkit==11.8.* cudnn==8.9.* numpy==1.* -y \
